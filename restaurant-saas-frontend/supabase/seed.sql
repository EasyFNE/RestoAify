...
-- Valeurs valides pour module_code :
-- orders | reservations | catering | healthy | contacts | menus | handoff | healthy_subscriptions
-- -----------------------------------------------------------------------------
INSERT INTO tenant_entitlements (id, tenant_id, module_code, feature_code, enabled, source, created_at, updated_at) VALUES
  ('ffffffff-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'contacts',      NULL, true,  'plan', '2025-01-12T10:00:00Z', '2025-01-12T10:00:00Z'),
  ('ffffffff-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 'orders',        NULL, true,  'plan', '2025-01-12T10:00:00Z', '2025-01-12T10:00:00Z'),
  ('ffffffff-0000-0000-0000-000000000003', '11111111-1111-1111-1111-111111111111', 'reservations',  NULL, true,  'plan', '2025-01-12T10:00:00Z', '2025-01-12T10:00:00Z'),
  ('ffffffff-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111111', 'catering',      NULL, false, 'plan', '2025-01-12T10:00:00Z', '2025-01-12T10:00:00Z'),
  ('ffffffff-0000-0000-0000-000000000005', '11111111-1111-1111-1111-111111111111', 'healthy',       NULL, false, 'plan', '2025-01-12T10:00:00Z', '2025-01-12T10:00:00Z'),
  ('ffffffff-0000-0000-0000-000000000006', '11111111-1111-1111-1111-111111111111', 'handoff',       NULL, true,  'plan', '2025-01-12T10:00:00Z', '2025-01-12T10:00:00Z'),
  ('ffffffff-0000-0000-0000-000000000007', '11111111-1111-1111-1111-111111111111', 'menus',         NULL, true,  'plan', '2025-01-12T10:00:00Z', '2025-01-12T10:00:00Z'),
  ('ffffffff-0000-0000-0000-000000000008', '22222222-2222-2222-2222-222222222222', 'contacts',      NULL, true,  'plan', '2025-02-20T10:00:00Z', '2025-02-20T10:00:00Z'),
...
INSERT INTO audit_logs (id, tenant_id, restaurant_id, actor_type, actor_id, entity_type, entity_id, action, metadata, created_at) VALUES
  ...
  ('22222222-0000-0000-0000-000000000004', '11111111-1111-1111-1111-111111111111', NULL,                                   'user',   'aaaaaaaa-0000-0000-0000-000000000002', 'entitlement', 'ffffffff-0000-0000-0000-000000000002', 'entitlement.enabled', '{"module_code": "orders"}',   '2025-01-15T10:00:00Z'),
