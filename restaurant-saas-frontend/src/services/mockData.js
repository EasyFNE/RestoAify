...
// ── Export nommé des IDs pour AuthContext (mode mock) ─────────────────────────
// AuthContext importe { ids } pour construire le currentUser mock.
// En mode supabase, ids n'est jamais utilisé à runtime mais l'import
// doit résoudre au chargement du module, sinon Vite renvoie undefined
// et le contexte d'auth se retrouve dans un état cassé → pages blanches.
export const ids = {
  TENANT_LE_SPOT,
  USER_PLATFORM,
  USER_OWNER_LS: USER_OWNER,
  USER_ADMIN,
  USER_STAFF,
  RESTO_LS_1,
  RESTO_LS_2,
